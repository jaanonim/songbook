...
const getPopularEvents = async function () {
    ...
    aggregate_options.push({
        $project: {
            ...
            description: 1,
            category: {
                $ifNull: ["$categories._id", null]
            },
            category_name: {
                $ifNull: ["$categories.name", null]
            },
            image: 1,
            createdAt: 1
        }
...
exports.index = async function (req, res) {
    ...
    let match_regex = {
        $regex: req.query.q,
        $options: 'i'
    }; //use $regex in mongodb - add the 'i' flag if you want the search to be case insensitive.
...
exports.store = async (req, res) => {
    try {
        ...
        const event_ = await Event.findByIdAndUpdate(event._id, {
            new: true
        });
...
exports.show = async function (req, res) {
    try {
        ...
        if (!event) return res.status(401).json({
...
exports.update = async function (req, res) {
    try {
        ...
        const event_ = await Event.findOneAndUpdate({
            _id: id,
            userId
        }, {
            new: true
...
exports.destroy = async function (req, res) {
    try {
        ...
        if (!event) return res.status(401).json({
            message: "Event does not exist or you don't have the required permission."
        });
